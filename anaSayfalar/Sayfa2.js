...
const mainURL = "https://rickandmortyapi.com/api/episode?page=2"
const ITEM_SIZE = 50 + 20 * 3;
const Sayfa2 = ({navigation, info}) => {
            ...
            <Animated.FlatList
              ...
              renderItem={({ item, index }) => {
                ...
                return <TouchableOpacity onPress={() => {
                  navigation.navigate("ScreenCharacter", item)
                }}
                  style={{
